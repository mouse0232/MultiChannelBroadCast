...
# 配置环境变量
cp .env.example .env
vim .env  # 编辑 CHANNELS、API_SECRET_KEY 等
...
📖 **完整文档**：[DOCKER_DEPLOYMENT.md](.monkeycode/docs/DOCKER_DEPLOYMENT.md)
...
📖 **更多 Docker 文档**：
- [部署指南](.monkeycode/docs/DOCKER_DEPLOYMENT.md)
...
**Docker 部署**：
- [部署指南](.monkeycode/docs/DOCKER_DEPLOYMENT.md) - 完整 Docker 部署教程
- [测试指南](DOCKER_TESTING_GUIDE.md) - Docker 测试指南
- [Docker 发布](.github/workflows/README_DOCKER_RELEASE.md) - GitHub Actions 自动构建指南
